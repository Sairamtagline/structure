...
const Points = () => {
    return (
        <div className='pb-sm-4 pb-2'>
            ...
            <Description>
                3  Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae
            </Description>
        </div>
    )
}
